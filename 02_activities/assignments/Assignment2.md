...
```
Type 1 would overwrite old address with new address and doesn't store any old addresses. Type 2 would retain the old addresses. In the ERD, type 2 will list all addresses of the customer and mark the changes by the date in which an update is made.
```
